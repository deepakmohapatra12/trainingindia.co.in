              ...
              <div class="box box-warning">
                <div class="box-header">
                  <h3 class="box-title">Seo
				   ...
				   <a class="btn btn-success btn-sm" href="taglist.php?userid=<?php echo $_GET['userid'];?>">BACK</a>
				  </h3>
                </div><!-- /.box-header -->
                <!-- form start -->
		<div class="box-body">
...
<script>
	...
	<?php
		...
		$ra="SELECT * FROM keywordrank where userid='".$_REQUEST['userid']."' and metaid='".$_REQUEST['metaid']."'"; 
...
$color ='';
	...
	<td><a href="<?php echo $row['url'];?>" target="_blank">View Website</a></td> 
